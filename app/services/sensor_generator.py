...
def generate_test_data():
    ...
    print(f"  CO2: {data['co2']} ppm (ID: {DEVICE_IDS['co2_sensor'][:8]}...)")
    print(f"  ЛОС: {data['voc']} ppb (ID: {DEVICE_IDS['voc_sensor'][:8]}...)")
    print(f"  PM2.5: {data['pm2_5']} ug/m3 (ID: {DEVICE_IDS['pm25_sensor'][:8]}...)")
    print(f"  PM10: {data['pm10']} ug/m3 (ID: {DEVICE_IDS['pm10_sensor'][:8]}...)")
